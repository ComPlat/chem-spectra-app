...
def test_find_displaying_spectrum(parsed_json_nmrium_data):
    nmrium_converter = NMRiumDataConverter()
    spectrum_data = nmrium_converter._NMRiumDataConverter__find_displaying_spectra(parsed_json_nmrium_data['spectra'])
    assert spectrum_data != None
...
def test_find_displaying_spectrum_id(parsed_json_nmrium_data):
    nmrium_converter = NMRiumDataConverter()
    spectrum_id = nmrium_converter._NMRiumDataConverter__find_displaying_spectrum_id(parsed_json_nmrium_data['correlations'])
...
def test_parsing_spectra(parsed_json_nmrium_data):
    ...
    nmrium_converter = NMRiumDataConverter()
    spectrum_data = nmrium_converter._NMRiumDataConverter__parsing_spectra(parsed_json_nmrium_data)
    assert spectrum_data != None
...
def test_read_xy_values_failed():
    nmrium_converter = NMRiumDataConverter()
    x_values, y_values = nmrium_converter._NMRiumDataConverter__read_xy_values(None)
...
def test_read_xy_values(parsed_json_nmrium_data):
    ...
    nmrium_converter = NMRiumDataConverter()
    spectrum_data = nmrium_converter._NMRiumDataConverter__parsing_spectra(parsed_json_nmrium_data)
    x_values, y_values = nmrium_converter._NMRiumDataConverter__read_xy_values(spectrum_data)
    assert x_values != None
    assert y_values != None
...
def test_parsing_xy_values(parsed_json_nmrium_data):
    ...
    nmrium_converter = NMRiumDataConverter()
    spectrum_data = nmrium_converter._NMRiumDataConverter__parsing_spectra(parsed_json_nmrium_data)
    xy_values = nmrium_converter._NMRiumDataConverter__parsing_xy_values(spectrum_data)
    assert xy_values != None
