...
def test_ni_composer_nmrium_integrals(jcamp_file_1h_edit):
    ...
    curr_integrals = integral[0]
    assert curr_integrals['originFrom'] == 1.3460178283178656
    assert curr_integrals['originTo'] == 4.068895984151519
    assert curr_integrals['from'] == 1.3460178283178656
    assert curr_integrals['to'] == 4.068895984151519
    assert curr_integrals['absolute'] == 2449915.5961841037
...
def test_ni_composer_nmrium_ranges(jcamp_file_1h_edit):
    ...
    # assert curr_integrals['from'] == 1.3460178283178656
    # assert curr_integrals['to'] == 4.068895984151519
    # assert curr_integrals['absolute'] == 2449932.117180566
