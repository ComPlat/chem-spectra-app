...
class NIComposer(BaseComposer):
    ...
    def tf_img(self):
        ...
        xlim_left, xlim_right = [x_min, x_max] if (self.core.is_tga or self.core.is_uv_vis or self.core.is_hplc_uv_vis or self.core.is_xrd or self.core.is_cyclic_volta or self.core.is_sec or self.core.is_cds) else [x_max, x_min]    # noqa: E501
